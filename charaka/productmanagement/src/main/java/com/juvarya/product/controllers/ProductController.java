...
import com.juvarya.product.dto.ProductTimingAttributesRequest;
import com.juvarya.product.dto.response.ProductResponse;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse<Page<ProductDTO>>>getProductsByRestaurantId(
            @PathVariable Long restaurantId,
            @RequestParam(required = false) String keyword,
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size) {

        log.info("Fetching products for restaurant ID: {}, keyword: {}", restaurantId, keyword);
        try {
            ...
            return ResponseEntity.badRequest().body(ProductResponse.error("Failed to fetch products for restaurant: " + e.getMessage()));
        }
    }
    ...
    public ResponseEntity<Page<ProductDTO>> getProductsByBusinessIdWithAttributeValue(
        ...
        log.info("Filtering products for restaurant ID: {}, attributes: {}, keyword: {}", businessId, attributeValues, keyword);
